	...
	return {
		...
		actions: {
			...
			getPostByUserId: async () => {
				...
				// Fetch
				let urlAPI = "https://3001-silver-spider-kikqr32d.ws-us04.gitpod.io/api/getPostbyUserId";
			...
			getCredentials: async () => {
				...
				const urlAPI = "https://3001-silver-spider-kikqr32d.ws-us04.gitpod.io/api/getCredentials";
			...
			getPostById: async id => {
				...
				// URL API
				const urlAPI = "https://3001-silver-spider-kikqr32d.ws-us04.gitpod.io/api/getPostById/";
			...
			getPosts: async () => {
				...
				await fetch("https://3001-silver-spider-kikqr32d.ws-us04.gitpod.io/api/getPost", requestOptions)
					.then(response => response.json())
					.then(result => {
						tmpArray = result;
					})
